module PdfGenerator
  ...
  def server_f_pdf_responder
    ...
    pdf.text_box "Knack Reports", :align => :right
    pdf.font_size 14
    item = ["Below generated report for Server Fault user #{@user_info["items"][0]["display_name"]}",
  ...
  def super_u_pdf_responder
    ...
    pdf.text_box "Knack Reports", :align => :right
    pdf.font_size 14
    item = ["Below generated report for Super User user #{@user_info["items"][0]["display_name"]}",
  ...
  def ask_u_pdf_responder
    ...
    pdf.text_box "Knack Reports", :align => :right
    pdf.font_size 14
    item = ["Below generated report for Ask ubuntu user #{@user_info["items"][0]["display_name"]}",
